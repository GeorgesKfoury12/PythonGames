...
class TicTacToe():
    ...
    def make_move(self, square, letter):
        ...
        # then return True and if invalid return False
    ...
    def winner(self, square, letter):
        # winner if 3 in a row anywhere, we have to check all of the possibilites
...
def play(game, x_player, o_player, print_game = True):
    ...
    # iterate while the game still has empy squares
...
if __name__ == '__main__':
    ...
    print(f'after 100 games, we have {x_wins} X wins, {o_wins} O wins, {ties} ties')